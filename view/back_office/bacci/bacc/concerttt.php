...
$controllerPath = 'C:/xampp/htdocs/livethemusic/Controller/concertController.php';
...
<head>
    ...
    <title>Concert Management - LiveTheMusic</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4"><i class="fas fa-calendar-alt me-2"></i>Concert Management</h1>
                    ...
                    <div class="card mb-4 table-container" id="scroll-target">
                        <div class="card-header" style="background-color: rgba(255,0,85,0.1); border-bottom: 1px solid rgba(255,0,85,0.3); display: flex; justify-content: space-between; align-items: center;">
                            <div>
                                <i class="fas fa-calendar-alt me-1" style="color: var(--accent);"></i>
                                <span style="color: #fff; font-weight: 600;">Gestion des Concerts</span>
                            </div>
                            <button class="btn btn-sm btn-outline-neon" type="button" data-bs-toggle="collapse" data-bs-target="#addFormRow">
                                <i class="fas fa-plus"></i> Nouveau Concert
                            </button>
                        </div>
                        <div class="card-body">
                            ...
                            <?php if (isset($_GET['error'])): ?>
                                <div class="alert alert-danger">
                                    ...
                                    <p>Consultez les logs PHP pour plus de détails.</p>
                                </div>
                            <?php endif; ?>
                            
                            <?php if (isset($_GET['success']) && $_GET['success'] == '1'): ?>
                                <div class="alert alert-success">
                                    <strong>Succès!</strong> Le concert a été ajouté avec succès.
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-custom text-white">
                                    ...
                                    <tbody>
                                        <!-- Add Form -->
                                        <tr id="addFormRow" class="collapse" style="background-color: rgba(0,0,0,0.3); border-left: 3px solid var(--accent);">
                                            <form method="POST" action="concerttt.php" id="add-form" enctype="multipart/form-data">
                                                ...
                                                <td>
                                                    <button type="submit" name="ajouter_concert" class="btn btn-primary-custom btn-pulse">
                                                    ...
                                                    <td><?= htmlspecialchars($search_result['id_concert']) ?></td>
                                                     <td>
                                                        <?php if (!empty($search_result['image']) && $search_result['image'] != 'Images/default-avatar.png'): ?>
                                                            <img src="/livethemusic/<?= htmlspecialchars($search_result['image']) ?>" 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if (!empty($concert['image']) && $concert['image'] != 'Images/default-avatar.png'): ?>
                                                            <img src="/livethemusic/<?= htmlspecialchars($concert['image']) ?>" 
                                                                 style="width: 50px; height: 50px; object-fit: cover; border-radius: 4px;"
                                                                 alt="Image du concert">
                                                        <?php else: ?>
                                                            <span class="text-muted">Aucune image</span>
