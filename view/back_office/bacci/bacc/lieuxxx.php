...
$controllerPath = 'C:/xampp/htdocs/livethemusic/Controller/lieuxController.php';
...
<head>
    ...
    <title>Venue Management - LiveTheMusic</title>
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark">
        ...
        <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
            <div class="input-group">
                ...
                <button class="btn btn-primary-custom" id="btnNavbarSearch" type="button"><i class="fas fa-search"></i></button>
            </div>
        </form>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4"><i class="fas fa-map-marker-alt me-2"></i>Venue Management</h1>
                    ...
                    <div class="card mb-4 table-container" id="scroll-target">
                        <div class="card-header" style="background-color: rgba(255,0,85,0.1); border-bottom: 1px solid rgba(255,0,85,0.3); display: flex; justify-content: space-between; align-items: center;">
                            <div>
                                <i class="fas fa-map-marker-alt me-1" style="color: var(--accent);"></i>
                                <span style="color: #fff; font-weight: 600;">Gestion des Lieux</span>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="addFormRow" class="collapse" style="background-color: rgba(0,0,0,0.3); border-left: 3px solid var(--accent);">
                                            <form method="POST" action="lieuxxx.php" id="add-form" novalidate>
                                                ...
                                                <td>
                                                    <button type="submit" name="ajouter_ligne" class="btn btn-primary-custom btn-pulse">
