...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $groups = $controller->searchGroupsByName($searchTerm);
    
    // Display search results message
    echo '<div class="alert alert-info mt-3">Showing results for: "' . htmlspecialchars($searchTerm) . '" (' . count($groups) . ' results found)</div>';
} else {
    // If no search, get all groups
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark">
            ...
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" method="GET" action="">
                <div class="input-group">
                    <input class="form-control" type="text" name="search" placeholder="Search for groups..." aria-label="Search" aria-describedby="btnNavbarSearch" style="background-color: rgba(255, 255, 255, 0.1); color: white; border: 1px solid rgba(255, 0, 85, 0.3);" value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>" />
