    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <?php
                // Get pending applications count with forced refresh to ensure fresh data
                ...
                try {
                    ...
                    $applications = $partnerController->getPartnerApplications(true);
                ...
                ?>
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapsePartners" aria-expanded="true" aria-controls="collapsePartners">
                ...
                <div class="collapse show" id="collapsePartners" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link <?php echo ($current_page == 'index.php') ? 'active' : ''; ?>" href="../partner/index.php">View Partners</a>
                        <a class="nav-link <?php echo ($current_page == 'applications.php') ? 'active' : ''; ?> position-relative" href="../partner/applications.php">
                            Manage Applications
                            <?php if ($pendingCount > 0): ?>
